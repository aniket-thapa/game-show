      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <section className="bg-white p-6 rounded-xl shadow-sm">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold border-b pb-2 flex-grow">
              1. Game State & Setup
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="bg-gray-50 p-4 rounded-lg border">
                ...
                <p className="text-sm mb-1">
                  <strong>Q:</strong> {state.currentQuestion?.text}
                </p>
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                ...
                <p className="text-sm mb-1">
                  Team:{' '}
                  {state.activeTeam !== null ? state.activeTeam + 1 : 'None'}
                </p>
                <p className="text-sm">
                  Option Locked:{' '}
                  {state.lockedOption !== null
                    ? ['A', 'B', 'C', 'D'][state.lockedOption]
                    : 'None'}
                </p>
              </div>
            </div>
                  ...
                  <button
                    ...
                    className={
                      state.activeTeam === team
                        ? 'bg-blue-600 text-white shadow-md w-full px-4 py-2'
                        : 'bg-blue-100 text-blue-800 hover:bg-blue-200 w-full px-4 py-2'
                    }
                  >
                    Team {team + 1}
                  </button>
                  <div className="text-sm font-normal opacity-90 text-center">
